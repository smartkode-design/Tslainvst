...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[2rem] border border-white bg-white/50 text-card-foreground shadow-xl shadow-slate-200/50 backdrop-blur-2xl transition-all hover:shadow-primary/10",
      className
    )}
    {...props}
  />
