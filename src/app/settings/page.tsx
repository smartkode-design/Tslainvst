...
import { 
  ...
  ChevronRight, KeyRound, LogOut, CheckCircle2, ShieldAlert, Moon 
} from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 space-y-6 pb-24">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 shadow-sm flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-black text-slate-900 dark:text-white">Oluwaseun Aliyu</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">oluwaseun@example.com · +234 812 345 6789</p>
        ...
        <div className="pt-2">
          <Link href="/login">
            <Button variant="outline" className="w-full h-12 rounded-2xl border-rose-200 dark:border-rose-900/60 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 hover:text-rose-700 font-bold text-xs flex items-center justify-center gap-2">
